...
Audacium (the audio editor ) uses an autoconf-based build system, and 
the files are also included in the PortMidi download. The associated
files are tested only in the context of building Audacium, but if you
really prefer autoconf to cmake or want to include portmidi in another
autoconf-based project (like Audacium), maybe this will be useful.
...
6-dec-2012 Roger B. Dannenberg
   Copied notes on Autoconf from Audacium sources
