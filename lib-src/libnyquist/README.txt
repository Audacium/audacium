...
libnyquist currently only exists as part of Audacium.  For
information on using libnyquist as an embedded audio processor
within another application, contact the Audacium developers:

  https://lists.sourceforge.net/lists/listinfo/audacium-devel 
