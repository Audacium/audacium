...
in MatLab. It was ported to C++. To incorporate this code into Audacium,
...
When scorealign is used in Audacium, a different subclass of Audio_reader
will call into Audacium using a Mixer object to retrieve samples from
selected tracks.
