/**********************************************************************
  ...
  to avoid naming problems. This early implementation from Audacium has
  been upated and the current Audacium version imports wxChar, but if I
  ...
  within Audacium. For now, at least, I'm just renaming functions, 
