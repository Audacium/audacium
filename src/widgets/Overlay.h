...
/*
<b>How Audacium Redisplay Works \n
 Roger Dannenberg</b> \n
Oct 2010 \n

This is a brief guide to Audacium redisplay -- it may not be complete. It
is my attempt to understand the complicated graphics strategy.

One basic idea is that redrawing waveforms is rather slow, so Audacium
...
Audacium, the "2-level" invalidation works like this: Anything
...
existing bitmap can be used for waveform images. Audacium also
