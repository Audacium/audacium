...
public:
   ...
   // Set and Get values of the version major/minor/micro keys in audacium.cfg when Audacium first opens
...
private:
   ...
   // values of the version major/minor/micro keys in audacium.cfg
   // when Audacium first opens
