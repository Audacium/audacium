...
public:
   ...
   BenchmarkDialog( wxWindow *parent, AudaciumProject &project );
...
BenchmarkDialog::BenchmarkDialog(
   wxWindow *parent, AudaciumProject &project)
   :
...
void BenchmarkDialog::OnRun( wxCommandEvent & WXUNUSED(event))
{
   ...
   // This code will become part of libaudacium,
   ...
   system("ls .audacium_temp/* | wc --lines");
#endif
