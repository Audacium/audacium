...
TranscriptionToolBar::TranscriptionToolBar( AudaciumProject &project )
: ToolBar( project,
...
TranscriptionToolBar &TranscriptionToolBar::Get( AudaciumProject &project )
{
   auto &toolManager = ToolManager::Get( project );
   return *static_cast<TranscriptionToolBar*>( toolManager.GetToolBar(TranscriptionBarID) );
}

const TranscriptionToolBar &TranscriptionToolBar::Get( const AudaciumProject &project )
{
