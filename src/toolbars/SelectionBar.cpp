...
SelectionBar::SelectionBar( AudaciumProject &project )
...
SelectionBar &SelectionBar::Get( AudaciumProject &project )
{
   auto &toolManager = ToolManager::Get( project );
   return *static_cast<SelectionBar*>( toolManager.GetToolBar(SelectionBarID) );
}

const SelectionBar &SelectionBar::Get( const AudaciumProject &project )
{
