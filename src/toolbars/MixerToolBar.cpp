...
MixerToolBar::MixerToolBar( AudaciumProject &project )
...
MixerToolBar &MixerToolBar::Get( AudaciumProject &project )
{
   auto &toolManager = ToolManager::Get( project );
   return *static_cast<MixerToolBar*>( toolManager.GetToolBar(MixerBarID) );
}

const MixerToolBar &MixerToolBar::Get( const AudaciumProject &project )
{
...
void MixerToolBar::OnAudioCapture(wxCommandEvent & event)
{
   ...
   if ((AudaciumProject *) event.GetEventObject() != p)
   {
