...
an Audacium .aup file rather than Audacium having its own copies of the
data.

*//*****************************************************************//**

\class DependencyDialog
\brief DependencyDialog shows dependencies of an AudaciumProject on 
AliasedFile s.
...
static void GetAllSeqBlocks(AudaciumProject *project,
...
// Given an Audacium project and a hash mapping aliased block
...
void FindDependencies(AudaciumProject *project,
...
static void RemoveDependencies(AudaciumProject *project,
         ...
         S.StartHorizontalLay(wxALIGN_LEFT,0);
         {
            mFutureActionChoice =
               S.Id(FutureActionChoiceID).AddChoice(
                  ...
                  {
                     /*i18n-hint: One of the choices of what you want Audacium to do when
                     * Audacium finds a project depends on another file.*/
                     XO("Ask me") ,
                     /*i18n-hint: One of the choices of what you want Audacium to do when
                     * Audacium finds a project depends on another file.*/
...
bool ShowDependencyDialogIfNeeded(AudaciumProject *project,
                                  bool isSaving)
{
...
\n\nSome older Audacium projects may not be self-contained, and care \n\
