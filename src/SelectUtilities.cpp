...
void SelectNone( AudaciumProject &project )
{
   auto &tracks = TrackList::Get( project );
   for (auto t : tracks.Any())
      t->SetSelected(false);
...
void SelectAllIfNone( AudaciumProject &project )
{
...
bool SelectAllIfNoneAndAllowed( AudaciumProject &project )
{
...
(AudaciumProject &project, Track *t, bool shift, bool ctrl, bool modifyState)
{
   auto &tracks = TrackList::Get( project );
...
void DoSelectAll(AudaciumProject &project)
{
   DoSelectTimeAndTracks( project, true, true );
}

void DoSelectAllAudio(AudaciumProject &project)
{
...
void DoSelectSomething(AudaciumProject &project)
{
   auto &tracks = TrackList::Get( project );
   auto &selectedRegion = ViewInfo::Get( project ).selectedRegion;
