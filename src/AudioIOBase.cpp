...
void AudioIOBase::SetCaptureMeter(AudaciumProject *project, MeterPanelBase *meter)
{
...
void AudioIOBase::SetPlaybackMeter(AudaciumProject *project, MeterPanelBase *meter)
{
   if (( mOwningProject ) && ( mOwningProject != project))
      return;
