...
\class TrackPanel::AudaciumTimer
...
TrackPanel &TrackPanel::Get( AudaciumProject &project )
{
   return project.AttachedWindows::Get< TrackPanel >( sKey );
}

const TrackPanel &TrackPanel::Get( const AudaciumProject &project )
{
   return Get( const_cast< AudaciumProject & >( project ) );
}

void TrackPanel::Destroy( AudaciumProject &project )
{
...
/// Gets the pointer to the AudaciumProject that
/// goes with this track panel.
AudaciumProject * TrackPanel::GetProject() const
{
...
void TrackPanel::OnTimer(wxTimerEvent& )
{
   ...
   AudaciumProject *const p = GetProject();
...
IsVisibleTrack::IsVisibleTrack(AudaciumProject *project)
   : mPanelRect {
