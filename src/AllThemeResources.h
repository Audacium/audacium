...
from there.  Audacium will look for a file called "Pause.png".
...
#define LOGOWITHNAME_HEIGHT 200
   ...
   SET_THEME_FLAGS( resFlagNewLine );
   DEFINE_IMAGE( bmpAudaciumLogo48x48, wxImage( 48, 48 ), wxT("AudaciumLogo48x48"));
