...
AudaciumCommand and a shuttle system.  This allows commands to be used
...
and Name, but that is now replaced by the AudaciumCommand interface.  
...
CommandImplementation::CommandImplementation(
  AudaciumProject &project, OldStyleCommandType &type)
