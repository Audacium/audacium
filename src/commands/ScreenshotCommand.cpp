...
ScreenshotCommand::ScreenshotCommand()
{
   ...
   std::call_once( flag, []{
      AudaciumCommand::SetVetoDialogHook( MayCapture );
...
static AudaciumProject *pIdleHandlerProject = nullptr;
...
void ScreenshotCommand::SetIdleHandler( AudaciumProject &project )
{
   mIdleHandler = IdleHandler;
   pIdleHandlerProject = &project;
}

wxTopLevelWindow *ScreenshotCommand::GetFrontWindow(AudaciumProject *project)
{
   wxWindow *front = NULL;
...
void ScreenshotCommand::CapturePreferences( 
   const CommandContext & context,
   AudaciumProject * pProject, const wxString &FileName ){
...
void ScreenshotCommand::CaptureCommands( 
   ...
   AudaciumProject * pProject = &context.project;
...
wxRect ScreenshotCommand::GetTrackRect( AudaciumProject * pProj, TrackPanel * panel, int n){
...
wxString ScreenshotCommand::WindowFileName(AudaciumProject * proj, wxTopLevelWindow *w){
