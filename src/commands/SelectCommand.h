...
class SelectTimeCommand : public AudaciumCommand
{
public:
...
class SelectFrequenciesCommand : public AudaciumCommand
{
public:
   static const ComponentInterfaceSymbol Symbol;
...
class SelectTracksCommand : public AudaciumCommand
{
public:
   static const ComponentInterfaceSymbol Symbol;
...
class SelectCommand : public AudaciumCommand
{
public:
   static const ComponentInterfaceSymbol Symbol;
