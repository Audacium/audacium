   ...
   , public std::enable_shared_from_this<Track> // see SharedPointer()
{
 ...
 public:
   ...
   virtual Holder PasteInto( AudaciumProject & ) const = 0;
   ...
   , public ClientData::Base
{
 ...
 public:
   static TrackList &Get( AudaciumProject &project );
   static const TrackList &Get( const AudaciumProject &project );
 
   // Create an empty TrackList
   // Don't call directly -- use Create() instead
   explicit TrackList( AudaciumProject *pOwner );

   // Create an empty TrackList
   static std::shared_ptr<TrackList> Create( AudaciumProject *pOwner );
   ...
   AudaciumProject *GetOwner() { return mOwner; }
   const AudaciumProject *GetOwner() const { return mOwner; }
