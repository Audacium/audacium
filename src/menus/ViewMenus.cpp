...
double GetZoomOfSelection( const AudaciumProject &project )
{
...
double GetZoomOfPreset( const AudaciumProject &project, int preset )
{
...
namespace {
void DoZoomFitV(AudaciumProject &project)
{
   auto &viewInfo = ViewInfo::Get( project );
...
Handler( AudaciumProject &project )
   : mProject{ project }
{
   ...
   Menu( wxT("View"), XXO("&View"),
      ...
      Section( "Other",
         ...
         Command( wxT("ShowEffectsRack"), XXO("Show Effects Rack"),
            ...
            Options{}.CheckTest( [](AudaciumProject &project){
