...
/// the stop button.
bool MakeReadyToPlay(AudaciumProject &project)
{
...
void DoMoveToLabel(AudaciumProject &project, bool next)
{
...
{
   bool Duplex;
   gPrefs->Read(wxT("/AudioIO/Duplex"), &Duplex, false); // DA
         ...
         Menu( wxT("Options"), XXO("Transport &Options"),
            ...
            Section( "",
               Command( wxT("PinnedHead"), XXO("Pinned Play/Record &Head (on/off)"),
                  ...
                  AlwaysEnabledFlag,
                  Options{}.CheckTest([](const AudaciumProject&){
