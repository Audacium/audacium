...
AudaciumProject::AttachedWindows::RegisteredFactory sMacrosWindowKey{
...
void DoManagePluginsMenu(AudaciumProject &project, EffectType type)
{
...
BaseItemSharedPtr ExtraScriptablesIMenu()
{
   ...
   Menu( wxT("Scriptables1"), XXO("Script&ables I"),
      ...
      Command( wxT("SelectTime"), XXO("Select Time..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SelectFrequencies"), XXO("Select Frequencies..."),
         FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      ...
      Command( wxT("SetPreference"), XXO("Set Preference..."),
         FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SetClip"), XXO("Set Clip..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SetEnvelope"), XXO("Set Envelope..."),
         FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SetLabel"), XXO("Set Label..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SetProject"), XXO("Set Project..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() )
   ) ) };
   return menu;
}
...
BaseItemSharedPtr ExtraScriptablesIIMenu()
{
   ...
   Menu( wxT("Scriptables2"), XXO("Scripta&bles II"),
      Command( wxT("Select"), XXO("Select..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SetTrack"), XXO("Set Track..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("GetInfo"), XXO("Get Info..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("Message"), XXO("Message..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("Help"), XXO("Help..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("Import2"), XXO("Import..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("Export2"), XXO("Export..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      ...
      Command( wxT("SaveProject2"), XXO("Save Project..."),
         FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("Drag"), XXO("Move Mouse..."), FN(OnAudaciumCommand),
         AudioIONotBusyFlag() ),
