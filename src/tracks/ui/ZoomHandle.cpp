...
HitTestPreview ZoomHandle::HitPreview
   (const wxMouseState &state, const AudaciumProject *WXUNUSED(pProject))
{
...
(const TrackPanelMouseEvent &evt, AudaciumProject *)
{
...
UIHandle::Result ZoomHandle::Cancel(AudaciumProject*)
{
