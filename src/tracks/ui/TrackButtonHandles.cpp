...
(const wxMouseEvent &, AudaciumProject *pProject, wxWindow*)
{
...
TranslatableString MinimizeButtonHandle::Tip(
   const wxMouseState &, AudaciumProject &) const
{
...
(const wxMouseEvent &event, AudaciumProject *pProject, wxWindow*)
{
   using namespace RefreshCode;
...
(const wxMouseEvent &, AudaciumProject *pProject, wxWindow *WXUNUSED(pParent))
{
