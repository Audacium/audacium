...
public:
   ...
   void SetUseSnap(bool use, AudaciumProject *pProject);
   void Enter(bool forward, AudaciumProject *pProject) override;

   bool HasSnap() const;
   bool HasEscape() const override;

   bool Escape(AudaciumProject *pProject) override;
...
private:
   ...
   void Connect(AudaciumProject *pProject);

   void StartSelection(AudaciumProject *pProject);
