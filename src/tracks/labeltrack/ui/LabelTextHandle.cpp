...
void LabelTextHandle::Enter(bool, AudaciumProject *)
{
...
void LabelTextHandle::HandleTextClick(AudaciumProject &
...
UIHandle::Result LabelTextHandle::Cancel( AudaciumProject *pProject )
{
