...
UIHandle::Result StretchHandle::Cancel(AudaciumProject *pProject)
{
...
void StretchHandle::Stretch(AudaciumProject *pProject, int mouseXCoordinate, int trackLeftEdge,
   Track *pTrack)
{
   auto &viewInfo = ViewInfo::Get( *pProject );
