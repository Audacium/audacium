...
void WaveformVZoomHandle::Enter( bool, AudaciumProject* )
{
...
UIHandle::Result WaveformVZoomHandle::Cancel(AudaciumProject*)
{
   ...
   bool fixedMousePoint)
{
   ...
   default:
      ...
      // In release builds Audacium will ignore the zoom.
      wxFAIL_MSG("Zooming Case not implemented by Audacium");
      break;
   case kZoomReset:
   case kZoom1to1:
      {
