...
void SampleHandle::Enter(bool, AudaciumProject *)
{
...
(const wxMouseState &state, const AudaciumProject *WXUNUSED(pProject), bool unsafe)
{
...
UIHandle::Result SampleHandle::Cancel(AudaciumProject *pProject)
{
   mClickedTrack.reset();
