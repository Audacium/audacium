...
private:
   ...
   int AddTags(AudaciumProject *project, ArrayOf<char> &buffer, bool *endOfFile, const Tags *tags);
#ifdef USE_LIBID3TAG
...
ProgressResult ExportMP2::Export(AudaciumProject *project,
   std::unique_ptr<ProgressDialog> &pDialog,
...
int ExportMP2::AddTags(
   AudaciumProject * WXUNUSED(project), ArrayOf< char > &buffer,
