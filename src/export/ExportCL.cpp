/**********************************************************************
  ...
  This code allows Audacium to export data by piping it to an external
  program.
...
private:
   ...
   struct ExtendPath
   {
      ...
      ExtendPath()
      {
         ...
         wxString paths[] = {wxT("HKEY_LOCAL_MACHINE\\Software\\Lame for Audacium"),
                             wxT("HKEY_LOCAL_MACHINE\\Software\\FFmpeg for Audacium")};
         wxString npath;
         wxRegKey reg;
...
ProgressResult ExportCL::Export(AudaciumProject *project,
                                std::unique_ptr<ProgressDialog> &pDialog,
                                unsigned channels,
                                const wxFileNameWrapper &fName,
                                bool selectionOnly,
