...
EffectRack::EffectRack( AudaciumProject &project )
...
EffectRack &EffectRack::Get( AudaciumProject &project )
{
...
{
   // may throw
   // exceptions are handled in AudaciumApp::OnExceptionInMainLoop
