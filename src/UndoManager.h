...
// Events emitted by AudaciumProject for the use of listeners
...
{
 public:
   static UndoManager &Get( AudaciumProject &project );
   static const UndoManager &Get( const AudaciumProject &project );
 
   explicit
   UndoManager( AudaciumProject &project );
   ~UndoManager();
