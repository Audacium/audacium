# This CMake script is invoked to build the InnoSetup installer for Audacium
...
configure_file("${OUTPUT_DIR}/audacium.iss.in" "${OUTPUT_DIR}/audacium.iss")
...
execute_process(
    COMMAND
        ${INNO_SETUP_COMPILER} /Sbyparam=$p "audacium.iss"
    WORKING_DIRECTORY
        ${OUTPUT_DIR}
)
