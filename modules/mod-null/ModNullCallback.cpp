...
added into the standard Audacium Project Menus.
...
static CommandHandlerObject &ident(AudaciumProject&project)
{
...
// This is the function that connects us to Audacium.
...
{
   ix=ix;//compiler food
   // If we wanted to hide Audacium's Project, 
