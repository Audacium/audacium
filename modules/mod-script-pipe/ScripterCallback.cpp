...
// Audacium.  Because it forwards commands
// rather than handling them itself it can be used in
// other projects too.  
//
// Enabling other programs to connect to Audacium via a pipe is a potential 
...
// Send the received command to Audacium and build an array of response lines.
