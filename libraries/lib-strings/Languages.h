...
/*!
 @param audaciumPathList paths to search for .mo files, grouped into subdirectories for the different languages
...
STRINGS_API
wxString SetLang( const FilePaths &audaciumPathList, const wxString & lang );
