...
// GetVersionString
// REQUIRED for the module to be accepted by Audacium.
// Without it Audacium will see a version number mismatch.
...
extern "C" {                                                           \
   ...
   {                                                                   \
     /* Make sure that this version of the module requires the version \
      of Audacium it is built with.                                    \
      For now, the versions must match exactly for Audacium to         \
