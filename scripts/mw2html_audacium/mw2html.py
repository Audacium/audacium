...
Improved filtering.
Improved usability.
Customized for Audacium's manual wiki.
Minor tweaks (for Audacium) By James Crook, Nov 2009.
...
try:
    ...
    print(' https://github.com/audacium/audacium/blob/master/scripts/mw2html_audacium/htmldata.py')
    sys.exit()
...
errors = 0
conn = None
headers = {"User-Agent": "mw2html.py/Audacium"}
domain = ''
...
def monobook_fix_html(doc, page_url):
    ...
    doc = re.sub(r'Audacium Development Manual</title>', r'Audacium Manual</title>', doc )
...
def run(out=sys.stdout):
    ...
    deploy_file( "AudaciumLogo.png", r"alphamanual.audaciumteam.org/m/resources/assets/AudaciumLogo.png")
    deploy_file( "303.css", r"alphamanual.audaciumteam.org/m/skins/monobook/main.css/303.css")
    deploy_file( "headbg.jpg", r"alphamanual.audaciumteam.org/m/skins/monobook/headbg.jpg")
    deploy_file( "audio.png", r"alphamanual.audaciumteam.org/m/skins/monobook/audio.png")
    deploy_file( "bullet.gif", r"alphamanual.audaciumteam.org/m/skins/monobook/bullet.gif")
    deploy_file( "external.png", r"alphamanual.audaciumteam.org/m/skins/monobook/external.png")
    deploy_file( "external_rtl.png", r"alphamanual.audaciumteam.org/m/skins/monobook/external_rtl.png")
    deploy_file( "user.gif", r"alphamanual.audaciumteam.org/m/skins/monobook/user.gif")
    deploy_file( "video.png", r"alphamanual.audaciumteam.org/m/skins/monobook/video.png")
